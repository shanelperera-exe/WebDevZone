...
const Testimonials = () => {
  return (
    ...
    className='container mx-auto py-10 lg:px-32 w-full overflow-hidden' id='Testimonials'>
      <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>Customer <span className='underline underline-offset-1 decoration-1 under font-light'>Testimonials</span></h1>
                ...
                <div key={index} className='max-w-[340px] border shadow-lg rounded px-8 py-12 text-center'>
                    ...
                    <div className='flex justify-center gap-1 text-red-500 mb-4'>
                        {Array.from({ length: testimonial.rating }, (item, i) => {
                            return <img key={i} src={assets.star_icon} alt="star" className="inline-block w-4 h-4" />;
                        })}
                    </div>
