  ...
  return (
    ...
    md:px-20 lg:px-32 my-20 w-full overflow-hidden" id="Projects">
      ...
      <div className="flex justify-end items-center mb-8">
        ...
        <button className="p-3 bg-gray-200 rounded" aria-label="Next project" onClick={nextProject}>
      ...
      <div className="overflow-hidden">
        ...
        >
            ...
            <div
                key={index}
                className="relative flex-shrink-0 w-full sm:w-1/2 lg:w-1/4 px-2" // padding for spacing instead of gap
            >
